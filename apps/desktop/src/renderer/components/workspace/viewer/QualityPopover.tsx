...
/** Format a kbps value as a bitrate display string (kbps or Mbps). */
...
function sanitizeDiagnostics(stats: ViewerStats, quality: QualityLevel): string {
  const lines = [
    ...
    `Configured bitrate: ${stats.configuredBitrateKbps !== null ? formatKbps(stats.configuredBitrateKbps) : "unknown"}`,
    `Measured bitrate: ${stats.measuredBitrateKbps !== null ? formatKbps(stats.measuredBitrateKbps) : "unknown"}`,
