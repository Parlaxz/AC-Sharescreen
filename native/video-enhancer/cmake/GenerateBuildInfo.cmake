...
# (cmake -P with VHC_SOURCE_DIR and VHC_BINARY_DIR).

# When called from PRE_BUILD, variables are passed via -D
# Use custom variables to avoid CMAKE_SOURCE_DIR confusion in -P mode
if(NOT VHC_SOURCE_DIR)
  set(VHC_SOURCE_DIR "${CMAKE_SOURCE_DIR}")
endif()
if(NOT VHC_BINARY_DIR)
  set(VHC_BINARY_DIR "${CMAKE_BINARY_DIR}")
endif()
...
if(GIT_EXECUTABLE)
  execute_process(
    ...
    WORKING_DIRECTORY ${VHC_SOURCE_DIR}
  ...
  if(GIT_REPO_ROOT)
    ...
    set(GIT_WORK_DIR "${VHC_SOURCE_DIR}")
  endif()
...
if(NOT VHC_COMPILER_ID)
  ...
  set(COMPILER_ID "${VHC_COMPILER_ID}")
endif()
...
file(READ "${VHC_SOURCE_DIR}/src/BuildInfo.h.in" TEMPLATE)
...
file(WRITE "${VHC_BINARY_DIR}/generated/BuildInfo.h" "${CONTENT}")
